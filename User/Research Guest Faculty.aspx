<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Research Guest Faculty.aspx.cs" Inherits="User_Default2" %>
...
<%--<ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>&raquo;<li>Contact Us</li>--%>  
  ...
  <form id="form1" runat="server">  
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px;     line-height: 1.1; margin-right:10%;">Guest Lectures</h1>
                <br />
                <br />
              </div>
              <div class="card-body">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style=" text-align:center; width:80%;"  >
                  <thead style=" background-color:#6362bc; text-align:justify; color:#fff; font-family: Georgia, serif; font-size:16px; ">
                    <tr>
                      <th>Research Guest Lectures Name</th>
                      <th>Research Guest Lectures Designation</th>
                      <th>Research Guest Lectures Organization</th>
                      <th>Research Guest Lectures Topic</th>
                    </tr>
                  </thead>
                  <tbody>
    </HeaderTemplate>
    <ItemTemplate>
                    <tr>
                      <td style="width:20%; font-family: cursive;"><%#Eval("guest_facul_name")%></td>
                      <td style="width:15%; font-family: cursive;"><%#Eval("guest_facul_designa")%></td>
                      <td style="width:20%; font-family: cursive;"><%#Eval("guest_facul_organisa")%></td>
                      <td style="width:45%; font-family: cursive;"><%#Eval("guest_facul_topic")%></td>
                    </tr>
    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Research_Guest_Lectures]"></asp:SqlDataSource>
    </form>
