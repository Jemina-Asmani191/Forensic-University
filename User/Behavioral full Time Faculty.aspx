<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Behavioral full Time Faculty.aspx.cs" Inherits="User_Default2" %>
...
<div class="banner-container">
   ...
   <ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>»<li><a property="item" typeof="WebPage" title="Go to Institute of Forensic Science." href="#" class="post post-page">Institute of Behavioral Science</a></li>»<li>FullTIme Faculty</li> </ul>
                           </div>
                            </div>
                        </div>
                    </div>
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px; width:80%;    line-height: 1.1; ">Behavioral Science FullTime Faculty</h1>
                <br />
                     ...
                     <table>
                         ...
                         <tr>
                             <td class="res" style="width:60px;">
                                   ...
                                   <img src='../Behavioral Fulltime Faculty Image/<%# Eval("full_faculty_image") %>' style="margin-left:10%;" height="280px" width="130px" />
                             </td>
                             <td class="res">
    ...
    margin-top: 0 !important;"
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                 ...
                 SelectCommand="SELECT * FROM [Admin_Behavioral_Full_Faculty]">
             </asp:SqlDataSource>
