...
public partial class User_Default2 : System.Web.UI.Page
{
    ...
    void databind()
    {
        ...
        ds.Clear();
        qry = "select * from Admin_Students_Achievement";
        ...
        DataList_students.DataSource = pg;
        DataList_students.DataBind();
    }
    ...
    protected void DataList_students_SelectedIndexChanged(object sender, EventArgs e)
    {
