<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Behavioral Infrastructural Facilities.aspx.cs" Inherits="User_Default2" %>
...
<div class="banner-container">
  ...
  <form id="form1" runat="server">  
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px;     line-height: 1.1; margin-right:10%;">Infrastructural Facilities</h1>
                <br />
                <br />
              </div>
              <div class="card-body">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style=" text-align:center; width:80%;"  >
                  <thead style=" background-color:#6362bc; text-align:justify; color:#fff; font-family: Georgia, serif; font-size:16px; ">
                    <tr>
                      <th>IBS Laboratory Instruments</th>
                      <th>Purpose/Measurement Parameters</th>
                    </tr>
                  </thead>
                  <tbody>
    </HeaderTemplate>
    <ItemTemplate>
                    <tr>
                      <td style="width:15%; font-family: cursive;"><%#Eval("infrastructural_laboratory_instruments")%></td>
                      <td style="width:30%; font-family: cursive;"><%#Eval("infrastructural_purpose_parameters")%></td>                     
                    </tr>
    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Behavioral_Infrastructural_Facilities]"></asp:SqlDataSource>
    </form>
