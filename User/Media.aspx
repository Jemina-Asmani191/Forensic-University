<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Media.aspx.cs" Inherits="User_Default2" %>
...
<ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>&raquo;<li>Media</li>                                </div>
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px; width:80%;    line-height: 1.1; ">Media</h1>
                <br />

    <asp:DataList ID="DataList_media" runat="server" DataKeyField="media_id" 
            ...
            <table style="width: 100%; margin-left:25%; font-color:#c52d33; ">
                ...
                <tr >
                    ...
                    <td style="padding:5% 10% 1% 10%; ">
                            ...
                            <img src='../Media Image/<%#Eval("media_image") %>' Height="180px" Width="300px" />
                    </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding: 0% 10% 0% 10%; width:20%">
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("media_desc") %>' 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Media]"></asp:SqlDataSource>
