<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Event Calendar.aspx.cs" Inherits="User_Default2" %>
...
<ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>&raquo;<li>Event Calendar</li>                                
</div>
                            </div>
                        </div>
                    </div>
          ...
          <asp:Repeater ID="rptevent_calendar" runat="server" 
                onitemcommand="rptevent_calendar_ItemCommand" >
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px;     line-height: 1.1; margin-right:10%;">Event Calendar</h1>
                <br />
           ...
           <ItemTemplate>             
                            ...
                            <tr class="active"> 
                             <%--<th scope="row">1</th>--%>
                               <td style="width:25%;  "><img src='../Event Image/<%#Eval("event_image") %>' height="50px" width="160px"/></td> 
                              <h3>
                               <td style="color: #c52d33; font-family: poppinsmedium; font-size: 20px; padding-bottom: 1px; text-align:left; margin-left:0px;"><%#Eval("event_desc")%>
             ...
             <FooterTemplate>
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [Admin_Event_calendar]"></asp:SqlDataSource>
