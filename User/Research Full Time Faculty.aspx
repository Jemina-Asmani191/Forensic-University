<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Research Full Time Faculty.aspx.cs" Inherits="User_Default2" %>
...
<div class="banner-container">
   ...
   <ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>»<li><a property="item" typeof="WebPage" title="Go to Institute of Forensic Science." href="#" class="post post-page">Institute of Research & Development</a></li>»<li>FullTIme Faculty</li> </ul>
                           </div>
                            </div>
                        </div>
                    </div>
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px; width:80%;    line-height: 1.1; ">Research And Development FullTime Faculty</h1>
                <br />
                     ...
                     <table>
                         ...
                         <tr>
                             ...
                             <%--    <asp:Image ID="Image1" runat="server" Height="136px" 
                                   ...
                                   <img src='../Research Fulltime Faculty Image/<%# Eval("full_faculty_image") %>' style="margin-left:10%;" height="280px" width="130px" />
                             </td>
                             <td class="res">
    ...
    font-family: poppinssemibold;"
                                     Text='<%# Eval("full_faculty_quali") %>'></asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td style="width: 90px">
    ...
    margin-top: 0 !important;"
                                     Text='<%# Eval("full_faculty_desig") %>'></asp:Label>
                             </td>
                         </tr>
                         ...
                         <tr>
                             <td colspan="2">
                                 ...
                                 <asp:Label ID="Label7" runat="server" style="font-family: 'poppinsregular';"
                                     Text='<%# Eval("full_faculty_expr") %>'></asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td colspan="2">
                                 ...
                                 <asp:Label ID="Label9" runat="server" style="font-family: 'poppinsregular';"
                                     Text='<%# Eval("full_faculty_speci") %>'></asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td colspan="2">
                                 ...
                                 <asp:Label ID="Label11" runat="server" style="font-family: 'poppinsregular';"
                                     Text='<%# Eval("full_faculty_publica") %>'></asp:Label>
                             </td>
                         </tr>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                 ...
                 SelectCommand="SELECT * FROM [Admin_Research_FullTime_Faculty]">
             </asp:SqlDataSource>
