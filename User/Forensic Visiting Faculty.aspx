<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Forensic Visiting Faculty.aspx.cs" Inherits="User_Default2" %>
  ...
  <form id="form1" runat="server">  
              ...
              <div class="card-body">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style=" text-align:center; width:80%;"  >
                  <thead style=" background-color:#6362bc; text-align:justify; color:#fff; font-family: Georgia, serif; font-size:16px; ">
                    <tr>
                      <th>Visiting Faculty Name</th>
                      <th>Visiting Faculty Designation</th>
                      <th>Visiting Faculty Organization</th>
                      <th>Visiting Faculty Qualification</th>
                      <th>Visiting Faculty Specialization</th>
                    </tr>
                  </thead>
                  <tbody>
    </HeaderTemplate>
    <ItemTemplate>
                    <tr>
                      ...
                      <td style="width:20%; font-family: cursive;"><%#Eval("visiting_faculty_desig")%></td>
                      <td style="width:40%; font-family: cursive;"><%#Eval("visiting_faculty_organi")%></td>
                      <td style="width:10%; font-family: cursive;"><%#Eval("visiting_faculty_qualifi")%></td>
                      <td style="width:10%; font-family: cursive;"><%#Eval("visiting_faculty_specia")%></td>
                    </tr>
    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Forensic_Visiting_Faculty]"></asp:SqlDataSource>
    </form>
