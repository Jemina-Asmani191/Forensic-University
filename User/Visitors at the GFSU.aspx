<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Visitors at the GFSU.aspx.cs" Inherits="User_Default2" %>
...
<ul><li><a property="item" typeof="WebPage" title="Go to Gujarat Forensic Sciences University." href="Home.aspx" class="home">HOME</a></li>&raquo;<li>Visitors At the GFSU</li>                                
</div>
                            </div>
                        </div>
                    </div>
    ...
    <asp:DataList ID="DataList_visitors" runat="server" DataKeyField="visitor_id" 
    ...
    margin-bottom: 24px;
    margin-top: 3%;
    padding-bottom: 8px; width:100%;    line-height: 1.1; ">Visitors At The GFSU</h1>
                <br />
        </HeaderTemplate>
        <ItemTemplate>
            ...
            <table style="width: 100%; margin-left:25%; font-color:#c52d33; ">
                ...
                <tr >
                    ...
                    <td style="padding:5% 10% 1% 10%; ">
                            <img src='../Visitor Image/<%#Eval("visitor_image") %>' Height="180px" Width="300px" />
                    </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding: 0% 10% 0% 10%; width:20%">
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("visitor_desc") %>' 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Visitors]"></asp:SqlDataSource>
