...
public partial class User_Default2 : System.Web.UI.Page
{
    ...
    void databind()
    {
        ...
        ds.Clear();
        qry = "select * from Admin_Event_Calendar";
        ...
        rptevent_calendar.DataSource = pg;
        rptevent_calendar.DataBind();
    }
    protected void rptevent_calendar_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
