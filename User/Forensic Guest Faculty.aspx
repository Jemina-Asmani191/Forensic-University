<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Master.master" AutoEventWireup="true" CodeFile="Forensic Guest Faculty.aspx.cs" Inherits="User_Default2" %>
...
<div class="banner-container">
  ...
  <form id="form1" runat="server">  
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style=" text-align:center; width:80%;"  >
                  <thead style=" background-color:#6362bc; text-align:justify; color:#fff; font-family: Georgia, serif; font-size:16px; ">
                    <tr>
                      ...
                      <th>Guest Faculty Qualification</th>
                      <th>Guest Faculty Specialization</th>
                    </tr>
                  </thead>
                  <tbody>
    </HeaderTemplate>
    <ItemTemplate>
                    <tr>
                      <td style="width:15%; font-family: cursive;"><%#Eval("guest_faculty_name")%></td>
                      <td style="width:20%; font-family: cursive;"><%#Eval("guest_faculty_desi")%></td>
                      <td style="width:30%; font-family: cursive;"><%#Eval("guest_faculty_organi")%></td>
                      <td style="width:10%; font-family: cursive;"><%#Eval("guest_faculty_quali")%></td>
                      <td style="width:20%; font-family: cursive;"><%#Eval("guest_faculty_specia")%></td>
                    </tr>
    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Admin_Forensic_Guest_Faculty]"></asp:SqlDataSource>
    </form>
