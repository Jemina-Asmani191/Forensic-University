<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Forgot_Password.aspx.cs" Inherits="ADMIN_Admin_Forgot_Password" %>
...
<!-- Mirrored from demos.creative-tim.com/paper-dashboard-2-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Feb 2019 04:23:48 GMT -->
...
<head>
  ...
  <link href="../ADMIN/assets/css/paper-dashboard.min790f.css?v=2.0.1" rel="stylesheet" />
...
<body class="login-page">
  ...
  <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
    <div class="container">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" style="font-size:xx-large">Forensic University</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page ">
    <div class="full-page section-image" filter-color="black" data-image="../ADMIN/assets/img/bg/fabio-mangione.jpg">
              ...
              <div class="card card-login">
                ...
                <div class="card-body ">
                  <div class="input-group">
                    ...
                    <%--<input type="text" class="form-control" placeholder="First Name...">--%>
                      <asp:TextBox ID="txtemail" runat="server" type="email" class="form-control" placeholder="Email" required=""></asp:TextBox>
                  </div>
                ...
                <div class="card-footer ">
                  <%--<a href="#pablo" class="btn btn-warning btn-round btn-block mb-3">Get Started</a>--%>
                    ...
                    <asp:Button ID="btn_forgot_password" class="btn btn-warning btn-round btn-block mb-3" 
                        runat="server" Text="Submit" onclick="btn_forgot_password_Click" />

                    <asp:Label ID="Labmsg" class="navbar-brand" style="color:Red"  runat="server" 
  ...
  <script src="../ADMIN/assets/js/paper-dashboard.min790f.js?v=2.0.1" type="text/javascript"></script>
  <!-- Paper Dashboard DEMO methods, don't include it in your project! -->
  <script src="../ADMIN/assets/demo/demo.js"></script>
  <!-- Sharrre libray -->
  <script src="../ADMIN/assets/demo/jquery.sharrre.js"></script>
  <script>
