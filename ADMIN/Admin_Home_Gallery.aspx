<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin_Master.master" AutoEventWireup="true" CodeFile="Admin_Home_Gallery.aspx.cs" Inherits="ADMIN_Default2" %>
...
<form id="RegisterValidation" Runat="server" >
 ...
 <div class="card ">
                <div class="card-header ">
                  <h4 class="card-title">Home Page Gallery</h4>
                </div>
                <div class="card-body ">
                 ...
                 <div class="input-group">
                  ...
                  <div class="form-group has-label">
                    <label>
                      ...
                      <asp:TextBox ID="txt_gallery_image_desc" class="form-control" runat="server" 
    ...
    <asp:GridView ID="gridview_home_gallery" runat="server" 
        ...
        <ItemTemplate >
            <img src='../Home Gallery Image/<%#Eval("gallery_image") %>' height="100px" width="200px" />
        </ItemTemplate>
        </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UniversityConnectionString1 %>"
        DeleteCommand="DELETE FROM [Admin_Home_Gallery] WHERE [gallery_id] = @gallery_id"
        InsertCommand="INSERT INTO [Admin_Home_Gallery] ([gallery_image], [gallery_desc]) VALUES (@gallery_image, @gallery_desc)"
        ProviderName="<%$ ConnectionStrings:UniversityConnectionString1.ProviderName %>"
        SelectCommand="SELECT [gallery_id], [gallery_image], [gallery_desc] FROM [Admin_Home_Gallery]"
        UpdateCommand="UPDATE [Admin_Home_Gallery] SET [gallery_image] = @gallery_image, [gallery_desc] = @gallery_desc WHERE [gallery_id] = @gallery_id">
        <DeleteParameters>
