  ...
  <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
    <div class="container">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" style="font-size:xx-large">Forensic University Admin Login</a>
      </div>
              ...
              <div class="card card-login">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <asp:TextBox ID="txtpassword" runat="server" type="password" 
                          placeholder="Password" class="form-control" MaxLength="15" required=""></asp:TextBox>
                  </div>
                  <br/>
                ...
                <div class="card-footer ">
                     ...
                     <div class="text-center p-t-115">
                            <a href="Admin_Forgot_Password.aspx"  title="Forgot Password">Forgot Password? </a><br/><br/>
                           
                        </div>
                    <asp:Button ID="btn_login" class="btn btn-warning btn-round btn-block mb-3" 
                        runat="server" Text="LOGIN" onclick="btn_login_Click" />

                    <asp:Label ID="Label1" class="navbar-brand" style="color:Red"  runat="server" Text=""></asp:Label>
                </div>
              </div>
            </form>
          </div>
