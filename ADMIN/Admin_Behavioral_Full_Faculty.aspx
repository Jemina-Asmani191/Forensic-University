<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin_Master.master" AutoEventWireup="true" CodeFile="Admin_Behavioral_Full_Faculty.aspx.cs" Inherits="ADMIN_Default" %>
...
<form id="RegisterValidation" Runat="server" >
              <div class="card ">
                <div class="card-header ">
                  <h4 class="card-title">Behavioral Science Full Time Faculty</h4>
                </div>
                <div class="card-body ">

                <label>
                    Behavioral Science Full Time Faculty Image
                </label>
                 <div class="input-group">
                      <div class="input-group-prepend">
                        ...
                        <asp:FileUpload ID="uploadfulltimefaculty_image" class="form-control" required="" placeholder="Behavioral Science Full Time Faculty" runat="server"   />
                    </div>

                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Name
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Qualification
                    </label>
                    ...
                    <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Designation
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty EmailId
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Experience
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Specialization
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Full Time Faculty Publication
                    </label>
...
<asp:GridView ID="gridview_behavioral_full_faculty" runat="server" CssClass="table table-striped table-bordered table-hover" 
    ...
    <Columns>
        ...
        <ItemTemplate >
            <img src='../Behavioral Fulltime Faculty Image/<%#Eval("full_faculty_image") %>' height="70px"  />
        </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:BoundField DataField="full_faculty_qualification" HeaderText="Full Faculty Qualification"
            SortExpression="full_faculty_qualification" />
        <asp:BoundField DataField="full_faculty_designation" HeaderText="Full Faculty Designation"
        ...
        <asp:BoundField DataField="full_faculty_experience" HeaderText="Full Faculty Exeperience"
            SortExpression="full_faculty_experience" />
        <asp:BoundField DataField="full_faculty_specialization" HeaderText="Full Faculty Specialization"
            SortExpression="full_faculty_specialization" />
        <asp:BoundField DataField="full_faculty_publication" HeaderText="Full Faculty Publication"
