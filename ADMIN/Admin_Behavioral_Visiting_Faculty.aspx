<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin_Master.master" AutoEventWireup="true" CodeFile="Admin_Behavioral_Visiting_Faculty.aspx.cs" Inherits="ADMIN_Default" %>
...
<form id="RegisterValidation" Runat="server" >
              <div class="card ">
                <div class="card-header ">
                  <h4 class="card-title">Behavioral Science Visiting Faculty</h4>
                </div>
                <div class="card-body ">
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Visiting Faculty Name
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Visiting Faculty Designation
                    </label>
                    ...
                    <div class="form-group has-label">
                    <label>
                     Behavioral Science Visiting Faculty Organization
                    </label>
                  ...
                  <div class="form-group has-label">
                    <label>
                     Behavioral Science Visiting Faculty Specialization
                    </label>
...
<asp:GridView ID="gridview_behavioral_visiting_faculty" runat="server" CssClass="table table-striped table-bordered table-hover" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="visiting_faculty_organi" HeaderText="Visiting Faculty Organization"
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UniversityConnectionString1 %>"
    DeleteCommand="DELETE FROM [Admin_Behavioral_Visiting_Faculty] WHERE [visiting_faculty_id] = @visiting_faculty_id"
    InsertCommand="INSERT INTO [Admin_Behavioral_Visiting_Faculty] ([visiting_faculty_name], [visiting_faculty_desig], [visiting_faculty_organi], [visiting_faculty_qualifi], [visiting_faculty_specia]) VALUES (@visiting_faculty_name, @visiting_faculty_desig, @visiting_faculty_organi, @visiting_faculty_qualifi, @visiting_faculty_specia)"
    ProviderName="<%$ ConnectionStrings:UniversityConnectionString1.ProviderName %>"
    SelectCommand="SELECT [visiting_faculty_id], [visiting_faculty_name], [visiting_faculty_desig], [visiting_faculty_organi], [visiting_faculty_qualifi], [visiting_faculty_specia] FROM [Admin_Behavioral_Visiting_Faculty]"
    UpdateCommand="UPDATE [Admin_Behavioral_Visiting_Faculty] SET [visiting_faculty_name] = @visiting_faculty_name, [visiting_faculty_desig] = @visiting_faculty_desig, [visiting_faculty_organi] = @visiting_faculty_organi, [visiting_faculty_qualifi] = @visiting_faculty_qualifi, [visiting_faculty_specia] = @visiting_faculty_specia WHERE [visiting_faculty_id] = @visiting_faculty_id">
    <DeleteParameters>
